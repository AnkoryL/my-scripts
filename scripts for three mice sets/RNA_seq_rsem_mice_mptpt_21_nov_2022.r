#nohup Rscript /data/AnkoryL46/rscripts/rscript/mice_mptpt_geo/RNA_seq_rsem_mice_mptpt_21_nov_2022.r > /data/AnkoryL46/nohup_logs/RNA_seq_rsem_mice_mptpt_21_nov_2022.r.log 2>&1 &
...
main_output_folder<-c("/data/AnkoryL46/RNA_seq/mice_mptpt_21_nov_2022")
input_folder<-c("/data/ivan/RNA_seq/mice_mptpt_21_nov_2022/raw")
...
output_file_fpkm<-c("/data/AnkoryL46/RNA_seq/mice_mptpt_21_nov_2022/mice_mptpt_21_nov_2022_rsem_fpkm.txt")
output_file_counts<-c("/data/AnkoryL46/RNA_seq/mice_mptpt_21_nov_2022/mice_mptpt_21_nov_2022_rsem_counts.txt")
